...
oracle_samples_path = 'data/image_coco.data'
...
if __name__ == '__main__':
    ...
    gen_optimizer = optim.Adam(gen.parameters(), lr=3e-2)
    losses = train_generator_MLE(gen, gen_optimizer, oracle, oracle_samples, MLE_TRAIN_EPOCHS)
    ...
    for epoch in range(ADV_TRAIN_EPOCHS):
        ...
        sys.stdout.flush()
        pgloss = train_generator_PG(gen, gen_optimizer, oracle, dis, 1)
        losses.append(pgloss)

        # TRAIN DISCRIMINATOR
        print('\nAdversarial Training Discriminator : ')
        train_discriminator(dis, dis_optimizer, oracle_samples, gen, oracle, 5, 3)
    
    torch.save(losses, 'loss.txt')
